    ...
    <div class="container">
        ...
        <div class="card">
            <div class="card-header">
                ...
                <a href="{{ route('professeurs.create') }}" class="btn btn-success btn-sm float-end">Ajouter un Nouveau Professeur</a>
            </div>
                        ...
                        @if (count($professeurs) > 0)
                            @foreach ($professeurs as $professeur)
                                <tr>
                                    ...
                                    <td>{{ $professeur->created_at }}</td>
                                    <td>{{ $professeur->updated_at }}</td>
                                    <td>
                                        <a href="{{ route('professeurs.edit', $professeur->id) }}" class="btn btn-primary btn-sm">Modifier</a>
                                    </td>
                                    <td>
