...
<body>
    ...
    <!-- Contenu principal -->
    <div class="container">
        <h1 class="mb-4 text-center">Choisir un groupe pour le module : <span class="text-primary">{{ $modulle->nom }}</span></h1>
        <div class="list-group">
            @foreach ($groupes as $group)
                <a href="{{route('seances.showForm',['id' =>$group->id])}}" class="list-group-item list-group-item-action">
                    {{ $group->nom }}
                </a>
            @endforeach
        </div>
