...
<div class="container">
    ...
    <div class="title-container">
        <h1 class="main-title">
            <img src="logo-emsi.png" alt="Logo EMSI" class="title-logo"> Cahier de Textes (Semestre 1)
        </h1>
    </div>

    <!-- Sous-titre avec traits, soulignement et logo -->
    <div class="subtitle-container">
        <h2 class="subtitle">
            <img src="logo-emsi.png" alt="Logo EMSI" class="subtitle-logo"> Année universitaire : 2024/2025
        </h2>
    </div>
</div>
<div class="container">
...
<?php /**PATH /home/yassineamjad/ikramFromGit/resources/views/page1.blade.php ENDPATH**/ ?>